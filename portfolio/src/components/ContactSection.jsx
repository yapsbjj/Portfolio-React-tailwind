                    ...
                    <div className="space-y-6 justify-center">
                        <div className="flex items-start space-x-4">
                            <div className="p-3 rounded-full bg-primary/10">
                              <Mail  className="h-6 x=w-6 text-primary"/>
                            </div>

                            <div>
                                <h4 className="font-medium">Email</h4>
                                <a href="mailto:ya.ramdane01@gmail.com" 
                                className="text-muted-foreground hover:text-primary transition-colors "> ya.ramdane01@gmail.com</a>
                            </div>
                         ...
                         <div className="flex items-start space-x-4">
                            <div className="p-3 rounded-full bg-primary/10">
                              <Phone  className="h-6 x=w-6 text-primary"/>
                            </div>

                            <div>
                                <h4 className="font-medium">Phone</h4>
                                <a href="tel:+33679316117" 
                                className="text-muted-foreground hover:text-primary transition-colors "> +33 6 79 31 61 17</a>
                            </div>
                         ...
                         <div className="flex items-start space-x-4">
                            <div className="p-3 rounded-full bg-primary/10">
                              <MapPin className="h-6 x=w-6 text-primary"/>
                            </div>

                            <div>
                                <h4 className="font-medium">Location</h4>
                                <a className="text-muted-foreground hover:text-primary transition-colors "> Eragny sur Oise France</a>
                            </div>
